...
export default function HomePage() {
  return (
    <div>
      ...
      {/* Section Title */}
      <h2 id="about" className="text-5xl pt-10 font-bold text-textColor text-center">About Me</h2>

      {/* About Section */}
      <section className="flex items-center justify-center p-10 pb-0 max-w-3/4 mx-auto">
        <p className="mt-4 text-textColor2 max-w-full text-3xl text-center">
      ...
      {/* Section Title */}
      <h2 id="workexp" className="text-5xl pt-10  font-bold text-textColor text-center">Experience</h2>
      ...
      <section className="flex flex-col items-center p-8 space-y-8 max-w-3/4 mx-auto">
        ...
        <div className="px-4 py-4 mx-auto font-normal bg-background2 border-borderColor rounded-lg w-full max-w-[900px]">
          ...
          <p className="text-textColor2">5 Years (2019 - 2024)</p>
        ...
        <div className="px-4 py-4 mx-auto font-normal bg-background2 border-borderColor rounded-lg w-full max-w-[900px]">
          ...
          <p className="text-textColor2">5 Months of Curricular Internship (30/10/2023 until 28/03/2024)</p>
            <ul className="list-disc pl-5">
              <li className="text-headingColor">
        ...
        <div className="px-4 py-4 mx-auto font-normal bg-background2 border-borderColor rounded-lg w-full max-w-[900px]">
          ...
          <p className="text-textColor2">9 Months of Paid Internship (28/03/2024 until 31/12/2024)</p>
            <ul className="list-disc pl-5">
              <li className="text-headingColor">
                    Worked as a Full-Stack Developer
              </li>
        ...
        <div  className="px-4 py-4 mx-auto font-normal bg-background2 border-borderColor rounded-lg w-full max-w-[900px]">
          ...
          <p className="text-textColor2">11 Months (03/02/2024 until 31/12/2024)</p>
            <ul className="list-disc pl-5">
              <li className="text-headingColor">
      ...
      {/* Section Title */}
      <h2 id="projects" className="text-5xl pt- font-bold text-textColor text-center">Projects</h2>

      {/* Projects Section */}
      <section className="flex flex-col xl:flex-row gap-6 items-center justify-center p-8 max-w-[1500px] mx-auto">

        {/* WatchList Wizard*/}
        <div className="bg-background2 p-5 flex flex-col items-center  border-b mb-10 border-borderColor rounded-lg w-[450px] h-[400px]">
            ...
            <div className="flex-grow text-center mt-6 sm:mt-0">
                <h1 className="text-textColor font-bold text-2xl">Watchlist Wizard</h1>
                <h3 className="text-textColor2 font-bold text-lg  mb-3">Track favorite movies and shows!</h3>  
                
                <p className="text-headingColor">This project was created to be a personal use App. It was made in 2024/2025 with <strong className="font-bold">Angular</strong> for the Front-End and Back-End, with <strong className="font-bold">Capacitor</strong> to transform it into an Android App and <a href="https://www.themoviedb.org/" className="underline text-headingColor hover:text-highlight">The Movie Database</a> for API.</p>
        ...
        <div className="bg-background2 p-5 flex flex-col items-center  border-b mb-10 border-borderColor rounded-lg w-[450px] h-[400px]">
          ...
          <div className="flex-grow text-center mt-6 sm:mt-0">
              <h1 className="text-textColor font-bold text-2xl">Gameify</h1>
              <h3 className="text-textColor2 font-bold text-lg  mb-3">A Game Price Tracker and Info Extractor!</h3>  
              
              <p className="text-headingColor">This project was created in 2022, using <strong className="font-bold">Flutter</strong> for the App, <strong className="font-bold">Python</strong> as an API Server that would extract/scrap the information from the websites needed and <strong className="font-bold">Firebase</strong> as a Database.</p>
        ...
        <div className="bg-background2 p-5 flex flex-col items-center border-b mb-10 border-borderColor rounded-lg w-[450px] h-[400px]">
          ...
          <div className="flex-grow text-center mt-6 sm:mt-0">
              <h1 className="text-textColor font-bold text-2xl">Side Projects</h1>
              <h3 className="text-textColor2 font-bold text-lg  mb-3">Collection of codes</h3>  
              
              <p className="text-headingColor">This repository is a curated collection of mostly Python scripts and small projects I&apos;ve built during my free time. It&apos;s a mix of practical tools, personal experiments, and teaching materials (during my time at <a className="underline text-headingColor hover:text-highlight" href="#adot">ADoT</a>).
              </p>            
              <div className="py-4">
                  <div className=" inline-block mr-2 mb-2" >
                      <div className="flex  pr-2 h-full items-center">
      ...
      {/* Section Title */}
      <h2 id="currentLearning" className="text-5xl pt-10  font-bold text-textColor text-center">Currently Learning</h2>
